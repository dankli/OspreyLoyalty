...
export type RouteSearchQuery = { routeSearch: { hops: number, totalKm: number, totalMin: number, legs: Array<{ km: number, min: number, from: { iata: string, name: string, city: string, country: string }, to: { iata: string, name: string, city: string, country: string }, carriers: Array<{ name: string }> }> } | null };
