...
import { fetchAirport, fetchAllAirports, fetchDestinations, searchAirports } from "./features/routes/routesClient.js";

export function buildYoga(deps: Deps = { fetchMember, fetchTransactions, fetchPartners, fetchRewards, postRedemption, searchAirports, fetchAirport, fetchDestinations, fetchAllAirports }): YogaServerInstance<{}, {}> {
