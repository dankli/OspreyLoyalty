...
public sealed class TiersCoreTests
{
    ...
    [Fact]
    public void Pandion_comes_only_by_invitation()
    {
        Assert.Equal(Tiers.Tier.Pandion, Tiers.Effective(0, isPandionInvited: true));
        Assert.Equal(Tiers.Tier.Diamond, Tiers.Effective(150_000, isPandionInvited: false));
    }

    [Fact]
    public void Points_to_next_counts_down_and_stops_at_pandion()
    {
